    ...
    return (
        <header className="h-12 flex items-center justify-between px-6 bg-zed-header border-b border-zed-border">
            <div className="flex items-center gap-4">
                ...
                <div className="flex items-center text-text-secondary bg-zed-main border border-zed-border rounded px-2 py-0.5 h-7 focus-within:border-primary/50 transition-all group">
