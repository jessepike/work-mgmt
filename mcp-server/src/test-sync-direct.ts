...
async function testSync() {
    ...
    // 1. Resolve files
    const tasksFile = path.join(PROJECT_PATH, "docs", "tasks.md");
    const backlogFile = path.join(PROJECT_PATH, "BACKLOG.md"); // Doesn't exist, but parser should handle if we check
